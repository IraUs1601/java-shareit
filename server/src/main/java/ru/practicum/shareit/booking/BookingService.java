    ...
    public List<BookingDto> getBookings(Long userId, String state) {
        ...
        switch (state.toUpperCase()) {
            ...
            case "FUTURE":
                ...
                break;
            case "WAITING":
                bookings = bookingRepository.findByStatusAndBookerIdOrderByStartDesc(
                        Booking.BookingStatus.WAITING, userId);
                break;
            case "REJECTED":
                bookings = bookingRepository.findByStatusAndBookerIdOrderByStartDesc(
                        Booking.BookingStatus.REJECTED, userId);
                break;
            default:
    ...
    public List<BookingDto> getBookingsForOwner(Long ownerId, String state) {
        ...
        switch (state.toUpperCase()) {
            ...
            case "FUTURE":
                ...
                break;
            case "WAITING":
                bookings = bookingRepository.findByStatusAndItemOwnerIdOrderByStartDesc(
                        Booking.BookingStatus.WAITING, ownerId);
                break;
            case "REJECTED":
                bookings = bookingRepository.findByStatusAndItemOwnerIdOrderByStartDesc(
                        Booking.BookingStatus.REJECTED, ownerId);
                break;
            default:
